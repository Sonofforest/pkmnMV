...
#===============================================================================
  ...
  ROCKCLIMB_CONFIG = {
    :internal_name      => :OCARINACLIMB,    # Default: ROCKCLIMBITEM
    :active             => true,              # Default: true
    :needed_badge       => 0,                 # Default: 0
    :needed_switches    => [],                # Default: []
    :use_in_debug       => false,             # Default: false
    #TerrainTagNumber
    :number_rockclimb   => 17,                # Default: 18
    :number_rockcrest   => 18,                # Default: 19
    #Animation Number
    :debris_id          => 33,                # Default: 19
    :move_up_id         => 32,                # Default: 20
#    :move_left_id       => 21,                # Default: 21
#    :move_right_id      => 22,                # Default: 22
    :move_down_id       => 32,                # Default: 23
    :dust_id            => 34,                # Default: 24
    :base_rockclimb     => true              # Default: false
  }
end
