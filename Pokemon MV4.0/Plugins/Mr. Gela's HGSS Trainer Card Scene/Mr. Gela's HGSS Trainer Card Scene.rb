...
class PokemonTrainerCard_Scene
  ...
  def pbDrawTrainerCardFront
    ...
    textPositions = [
       ...
       [_INTL("${1}", $player.money.to_s_formatted), 362 + 2, 118 + 12, 1, base, shadow],
       [_INTL("PUNTOS BATALLA"), 144+16, 118 + 60, 0, base, shadow],
       [sprintf("%d", $player.battle_points), 302 + 60, 118 + 60, 1, base, shadow],
       [_INTL("MEDALLAS"), 144+16, 214+28, 0, base, shadow],
       [sprintf("%d", $player.badge_count), 302 + 2, 214+28, 1, base, shadow],
       ...
       [starttime, 302 + 119 * 2, 262 + 60, 1, base, shadow]
    ]
