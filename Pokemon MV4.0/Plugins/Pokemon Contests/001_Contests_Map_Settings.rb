...
#====================================================================================
	...
	#--------------------------------------------------------------------------------
	DEFAULT_RETURN_COORDINATES 	= [DEFAULT_LOBBY_MAP_ID, 6, 4, 2] # [Lobby Map ID, x, y, facing direction] directions: 2=down,4=left,6=right,8=up
...
#====================================================================================
	...
	ROOM_MAP_COORDINATES = [ 
		[[233,12,9],nil,nil,nil,nil], # Normal: Cool(default), Beauty, Cute, Smart, Tough
		[[234,12,9],nil,nil,nil,nil], # Super: Cool(default), Beauty, Cute, Smart, Tough
		[[235,12,9],nil,nil,nil,nil], # Hyper: Cool(default), Beauty, Cute, Smart, Tough
		[[236,12,9],nil,nil,nil,nil] # Master: Cool(default), Beauty, Cute, Smart, Tough
	]
