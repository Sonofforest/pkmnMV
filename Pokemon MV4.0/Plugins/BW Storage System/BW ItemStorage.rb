...
class ItemStorage_Scene
  ...
  def pbRefresh
    ...
    drawTextEx(bm, 0, 8, bm.width, 2, @title, ITEMTEXTBASECOLOR, ITEMTEXTSHADOWCOLOR)
    ...
    if itemwindow.item
      ...
      @sprites["itemtextwindow"].text = _INTL("Cerrar el almacenamiento.")
    end
    itemwindow.refresh
  end
